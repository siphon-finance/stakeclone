...
import { Typography, Button, Card, TextField, InputAdornment } from '@material-ui/core';
...
import { ERROR, CONFIGURE_RETURNED, GET_CLAIMABLE_ASSET, GET_CLAIMABLE_ASSET_RETURNED, GET_CLAIMABLE, GET_CLAIMABLE_RETURNED, CLAIM, CLAIM_RETURNED } from '../../constants';
...
class Claim extends Component {
  ...
  render() {
    ...
    const { value, account, loading, modalOpen, snackbarMessage, title, titleError, description, descriptionError, asset } = this.state;
        ...
        <div className={classes.claimContainer}>
          ...
          <div className={classes.stakeButtons}>
            <div className={classes.priceContainer}>
              <Typography variant="h4" className={classes.priceConversion}>
                Rewards available:{' '}
              </Typography>
              <Typography variant={'h4'} className={classes.priceConversion}>
  ...
  renderAssetInput = (asset, type) => {
    ...
    const { loading, amount, amountError } = this.state;
      ...
      <div className={classes.valContainer} key={asset.id}>
        <div className={classes.balances}>
          <Typography
            variant="h4"
            onClick={() => {
              this.setAmount('amount', asset ? asset.balance : 0);
            }}
